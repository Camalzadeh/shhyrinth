...
public class Constants {
    ...
    //Player animations
    public static final String PLAYER_ANIM_LEFT = "runLeft";
    ...
    public static final String FIRE_SPELL_DOWN = "fireDown";
    public static final String FIRE_SPELL_LEFT_UP = "fireLeftUp";
    ...
    public static final float SLOWED_ENEMY_TIME = .5f;
